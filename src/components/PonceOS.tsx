...
const T = {
  ...
  es: {
    role: "Pasante de Consultoria en Ciberseguridad @ Arcova — Equipo de IA",
...
const EXPERIENCE = [
  {
    ...
    stack: ["Python", "FastAPI", "Next.js", "GCP", "Vertex AI", "LangChain"],
  },
  {
    ...
    log: [
      ...
      "Maintained and troubleshot network devices and lab systems used for cybersecurity teaching",
    ],
  ...
  },
  {
    ...
    log: [
      ...
      "Optimized multi-threaded event processing with Docker, cutting CPU usage 30%",
      "Created plug-and-play security APIs, accelerating K-12 deployment time by 60% across 10+ organizations",
    ],
    stack: ["Python", "TypeScript", "Docker"],
  },
  {
    id: "RAI-2025", org: "Reality AI Lab", role: "Software Engineer Intern", period: "JUN 2025 — AUG 2025",
    clearance: "REMOTE", loc: "New York, NY",
    log: [
      "Automated educators' workflows with React.js and Next.js, reducing manual tasks by 15%",
      "Built real-time APIs with LangChain and Redis for 1000+ concurrent users",
      "Accelerated deployments 40% via CI/CD with 85%+ test coverage",
    ],
    stack: ["React.js", "Next.js", "LangChain", "Redis"],
  },
  {
    id: "NBT-2022", org: "Nobile Tech", role: "Software Engineer", period: "AUG 2022 — AUG 2025",
    clearance: "GAME SERVERS", loc: "New York, NY",
    log: [
      "Designed and launched 300+ custom game servers in Java scaling past 2,500 concurrent users",
      "Cut server downtime 60% with automated monitoring and debugging tooling",
      "Amplified client traffic 400% by launching 20+ web platforms",
    ],
  ...
  },
  {
    ...
    log: [
      "Enhanced gameplay reliability for 16.2B+ visits on MeepCity by scripting multiplayer systems in Lua",
      "Reduced crash rates 35% during peak traffic on core mechanics and live features",
      "Mentored 20+ developers across Roblox games, cutting debugging time 50%",
    ],
...
const PROJECTS = [
  ...
  {
    code: "CF-005", name: "TenantE", status: "MULTI-TENANT", date: "MAR — MAY 2025",
  ...
  {
    code: "CF-006", name: "GoPirate", status: "MULTIPLAYER", date: "APR — MAY 2025",
